...
mixin _$FastLaughState {
  List<DownloadsModels> get videolist => throw _privateConstructorUsedError;
...
abstract class $FastLaughStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<DownloadsModels> videolist, bool isLoading, bool isError});
}
...
class _$InitialImpl implements _Initial {
  const _$InitialImpl(
      {required final List<DownloadsModels> videolist,
      required this.isLoading,
      required this.isError})
      : _videolist = videolist;

  final List<DownloadsModels> _videolist;
  @override
  List<DownloadsModels> get videolist {
